...
pin: true
image:
  path: https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/wallhaven-3k85x9.jpg.webp
  alt: 微距镜头拍键盘还挺有格调的
---
...
<img src="https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/20250801165946281.png.webp" style="zoom: 67%;" alt=""/>
...
<img src="https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/cpu-vs-gpu.png.webp" style="zoom:50%;" alt=""/>
...
![image-20260201153105974](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260201153105974.png.webp)
...
![image-20260201153353483](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260201153353483.png.webp)
...
![image-20260201153452106](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260201153452106.png.webp)
...
![image-20260201151412190](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260201151412190.png.webp)
...
![image-20260130115547511](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260130115547511.png.webp)
...
![image-20260130115725904](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260130115725904.png.webp)
...
![image-20260130115954824](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260130115954824.png.webp)

利用虚拟时钟：假设输入或者输出端口接在某一时序器件上，定义该时序器件时钟为虚拟时钟；利用 set_input_delay/set_output_delay 将相应端口归到虚拟时钟时序上

![image-20260130115949339](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260130115949339.png.webp)
...
![image-20260129111023646](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260129111023646.png.webp)
...
![image-20260129111620593](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/image-20260129111620593.png.webp)
...
![image-20251214212000690](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/333.png.webp)

典型的时序模型如下。完整的时序路径包括源时钟路径、数据路径和目的时钟路径，也可以表示为触发器+组合逻辑+触发器的模型。

![image-20251214212720165](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/444.png.webp)
...
![image-20251214222348267](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/666.png.webp)
...
![SIPU 指令调度 case 重绘图](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/96a45ab7-e911-4bba-b60a-0a9929210fae_nowatermark_no_sipu.png.webp)
...
![SIPU 硬件总体架构重绘图](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/d4fa8387-46a7-469a-9e22-cc87cc3cf53a_nowatermark_no_sipu.png.webp)

每个 PE 配备 1MB 的 L2B，作为 shared memory；每个 PEC 配备 4GB DRAM，四个 PEC 的 DRAM 以 interleave 方式组成一个 16GB 的整体，作为 global memory。

![SIPU PEC 和内存组织重绘图](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/bcb155b8-0b5b-4a2b-81a6-23edbd419457_nowatermark_no_sipu_white_bg.png.webp)
...
![SIPU PE 内部结构重绘图](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/1ea348ee-41d5-4703-8512-eee84b0e5add_nowatermark_no_sipu.png.webp)
...
![Arch Model 架构图](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/whiteboard_exported_image_nowatermark_no_sipu.png.webp)

目前 ESL Model 的架构图

![ESL Model 架构图-system](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/whiteboard_exported_image_nowatermark_no_sipu111.png.webp)

![ESL Model 架构图-PE](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/optimized/whiteboard_exported_image_nowatermark_no_sipu222.png.webp)
