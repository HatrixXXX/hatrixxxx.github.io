...
tmux 是一个终端复用工具（terminal multiplexer），可以在一个终端窗口里创建和管理多个会话、窗口和面板；它最大的作用是让程序在后台持续运行，即使 SSH 断开或关闭终端，也可以之后重新连接回来继续操作。因此，tmux 很适合远程服务器开发、长时间运行脚本、同时查看日志和编辑代码等场景。常见操作包括新建会话、分屏、切换窗口、detach 退出当前会话但保持任务运行，以及 attach 重新进入会话。
...
梯子，又称科学上网工具，这是你东大特有的赛博传送门。“梯子”一般实际指的是本地使用的代理软件，而“机场”一般指的是提供代理服务的服务商。

[梯子原理](https://openevonix.pages.dev/posts/%E6%A2%AF%E5%AD%90%E5%8E%9F%E7%90%86%E4%B8%8Eclash.meta%E9%85%8D%E7%BD%AE1.%E6%A2%AF%E5%AD%90%E5%8E%9F%E7%90%86%E7%AE%80%E8%BF%B0)
...
![](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/image-20250526213843589.png)

### 工作空间

ROS 系统中一个典型的工作空间结构如图所示，dev_ws 为工作空间的根目录，其中包含四个子空间

![image-20250526213912348](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/image-20250526213912348.png)
...
![ROS2-topic](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/ROS2-topic.gif)
...
![ROS2-serve](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/ROS2-serve-1748266860703-4.gif)
...
![ROS2-action](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/ROS2-action.gif)
...
![image-20250526214023210](https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/image-20250526214023210.png)
