...
pin: false
image:
  path: https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/wallhaven-3k85x9.jpg
  alt: 微距镜头拍键盘还挺有格调的
---
...
<img src="https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/20250801165946281.png" style="zoom: 67%;" alt=""/>
...
2. 官方的使用说明和 CSDN 那篇文章有一点没有说清楚，在部署阶段选择源为“GitHub Actions”之后，需要到 Actions 选项卡开启 Actions，否则提交修改不会触发部署工作流。
   ...
   ![](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/20250706204906641.png)
...
![](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/20250706204931037.png)
...
22、80、443、3306、6379都是知名的网络端口，对应的服务分别为ssh、http、https、MySQL、Redis。
...
<img src="https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/C_memory_model.svg" style="zoom:240%;" alt=""/>
...
<img src="https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/cpu-vs-gpu.png" style="zoom:50%;" alt=""/>
...
![](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/CUDA_architecture111.svg)
...
![](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/image-20250526213843589.png)

### 工作空间

ROS 系统中一个典型的工作空间结构如图所示，dev_ws 为工作空间的根目录，其中包含四个子空间

![image-20250526213912348](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/image-20250526213912348.png)
...
![ROS2-topic](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/ROS2-topic.gif)
...
![ROS2-serve](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/ROS2-serve-1748266860703-4.gif)
...
![ROS2-action](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/ROS2-action.gif)
...
![image-20250526214023210](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/image-20250526214023210.png)
