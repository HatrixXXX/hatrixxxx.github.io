...
description: 拆解可编程 AI 加速器的研发目标、团队分工、workload 定义、计算系统、内存系统和多卡互联设计
math: true
mermaid: true
image:
  path: https://cdn.jsdelivr.net/gh/HatrixXXX/Hatrix-s-Blog-Image/img/cpu-motherboard-darkness-technology-wallpaper-preview.jpg
---
