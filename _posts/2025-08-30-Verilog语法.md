...
pin: false
image:
  path: https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/4367819656431584932.webp
  alt: Verilog Grammer
---
...
Verilog 中用函数和任务的机制来提取封装重复的行为级设计，避免重复代码的多次编写。function的本质是可复用的组合逻辑，不能描述时序逻辑。
...
![](https://cdn.jsdelivr.net/gh/HatrixXXXXX/Hatrix-s-Blog-Image/img/20250831093826185.png)
